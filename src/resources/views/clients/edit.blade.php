                ...
                <div class="grid">
                    ...
                    <div>
                        ...
                        <select id="is_active" name="is_active">
                            <option value="1" @selected(old('is_active',$client->is_active))>Ativo</option>
                            <option value="0" @selected(!old('is_active',$client->is_active))>Inativo</option>
                        </select>
                    </div>
                    ...
                    <div class="full">
                        ...
                        <div class="help">Preencha apenas se desejar trocar a senha.</div>
                    </div>
                </div>
